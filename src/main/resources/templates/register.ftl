                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/admin/regist">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="name" name="name" class="form-control" type="text" placeholder="请输入您的真实姓名。" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="phone" name="phone" class="form-control" placeholder="请输入您的电话号码。" >
                            </div>
                        </div>
            ...
            submitHandler:function(form){
                $.ajax({
                    ...
                    success: function(msg){
                        layer.msg(msg.msg, {time: 3000},function(){
